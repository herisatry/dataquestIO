...
/home/dq/random_numbers$ cat README.md "
...
/home/dq/random_numbers$ git config --global user.name "Herisatry"
...
/home/dq/random_numbers$ git commit -m "updated the script"
